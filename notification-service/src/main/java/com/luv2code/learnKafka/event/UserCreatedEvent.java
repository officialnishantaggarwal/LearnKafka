 ...
 */
package com.luv2code.learnKafka.event;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3278908765828302802L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.luv2code.learnKafka.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public static com.luv2code.learnKafka.event.UserCreatedEvent.Builder newBuilder() {
    return new com.luv2code.learnKafka.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.luv2code.learnKafka.event.UserCreatedEvent.Builder newBuilder(com.luv2code.learnKafka.event.UserCreatedEvent.Builder other) {
    return new com.luv2code.learnKafka.event.UserCreatedEvent.Builder(other);
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.luv2code.learnKafka.event.UserCreatedEvent.Builder newBuilder(com.luv2code.learnKafka.event.UserCreatedEvent other) {
    return new com.luv2code.learnKafka.event.UserCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.luv2code.learnKafka.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.luv2code.learnKafka.event.UserCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.luv2code.learnKafka.event.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.luv2code.learnKafka.event.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.luv2code.learnKafka.event.UserCreatedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.luv2code.learnKafka.event.UserCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.luv2code.learnKafka.event.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.luv2code.learnKafka.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
